#!/usr/bin/env python3
"""Turn the stress recording into one narrated, subtitled 1080p video.
...
single file rather than four parts.
    ...
    python docs/demo/build_stress.py
"""
...
SLUG = "canlab-stress-test"


def main() -> int:
    scenes_path = BUILD / "scenes.json"
    if not scenes_path.exists():
        raise SystemExit("run docs/demo/record_stress.py first")
