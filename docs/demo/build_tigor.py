#!/usr/bin/env python3
"""Turn the Tigor EV recording into one narrated, subtitled 1080p video.
...
single file rather than four parts.
    ...
    python docs/demo/build_tigor.py
"""
...
BUILD = HERE / "build-tigor"
OUT_DIR = HERE.parent                                       # docs/
SLUG = "canlab-tigor-ev"


def main() -> int:
    scenes_path = BUILD / "scenes.json"
    if not scenes_path.exists():
        raise SystemExit("run docs/demo/record_tigor.py first")
